...
<b><?php print t('Cadastro de currículo via site'); ?></b><br /><br />
<?php print t('Submitted on @date', array('@date' => format_date(time(), 'small'))) ?><br />
<?php if ($user->uid): ?>
...
<?php endif; ?><br /><br />
<b><?php print t('Submitted values are') ?></b><br />
<?php
...
?>
<br /><br />
<?php print t('The results of this submission may be viewed at:') ?><br />
