...
<link href="<?php print base_path() . path_to_theme(); ?>/style-profissional.css" rel="stylesheet" media="all" />
<?php print $scripts ?>
<!--[if lt IE 8]>
...
<div class="container">
  ...
  <!-- /#header -->
  <div class="barra-nome-divisao"> <a href="<?php print base_path(); ?>profissional">Profissional</a> </div>
  ...
  ?>
    ...
    <div id="main-front-page" class="profissional">
