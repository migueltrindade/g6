...
<link href="<?php print base_path() . path_to_theme(); ?>/style-treinamentos.css" rel="stylesheet" media="all" />
<?php print $scripts ?>
<!--[if lt IE 8]>
...
<div class="container">
  ...
  <!-- /#header -->
  <div class="barra-nome-divisao"><a href="<?php print base_path(); ?>treinamentos">Treinamentos e Eventos Corporativos</a></div>
  ...
  ?>
	...
	?>
    <?php if ($show_messages && $messages): print $messages; endif; ?>
    <div id="main-front-page" class="treinamentos">
