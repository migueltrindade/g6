...
1. Copy the user_force_term folder to sites/all/modules or to a site-specific
   modules folder.
2. Go to Administer > Site building > Modules and enable the User Force Term
   module.
...
3. Go to Administer -> User management -> Users -> Force taxonomy term and
   choose the vocabulary you just created and populated.
4. Go to Administer -> User management -> Users and edit the users whose
...
$Id: README.txt,v 1.2.4.2 2009/11/23 15:16:04 wulff Exp $